        ...
        <Link href={post.url_path} className="flex p-2">
            <div className="group flex w-full flex-col gap-y-2 text-black dark:text-white">
                <div className="relative h-250pxr w-full overflow-hidden">
                    <div className="absolute left-0 rigth-0 top-0 z-10 flex h-250pxr w-full flex-col items-start justify-between rounded-lg bg-black p-2 opacity-0 transition delay-100 ease-in-out group-hover:opacity-70">
